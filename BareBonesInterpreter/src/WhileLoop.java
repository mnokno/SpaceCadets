 ...
 * condition evaluates to true. The condition is evaluated before starting each new iteration.
 */
public class WhileLoop extends Command {
    ...
    /**
     * Execute the while statement returning when the loops condition evaluated to false.
